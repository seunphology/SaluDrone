...
import java.util.Scanner;
    ...
    public class Droid {
  /* I designed a mini drone that can charge itself whilst in flight but also loses battery life as it travels. i have designed it not to fly above 2 feet.Below is the procedure :
...
If you completed the project correctly, the output will indicate first a battery level of 95, then 100, then 80.
  ...
  */
        ...
        public void hover(int feet){
            ...
            if(feet>8){
                System.out.println("Error! I cannot hover above 8 feet");
            }else{
        ...
        public static void main(String[]args){
            ...
            System.out.println("Please, enter your unique Username for verification : ");

            String Uniqueuser = input.nextLine();

            Sign.SignIn(Uniqueuser);


            Droid seunDrone = new Droid();

            seunDrone.activate();

            seunDrone.chargeBattery(8);
